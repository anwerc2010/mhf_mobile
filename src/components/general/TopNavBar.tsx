            ...
            <View style={styles.container}>
                ...
                <View style={styles.rightSection}>
                    ...
                    >
                        ...
                        <Text style={styles.languageText}>{languages.find(l => l.code === selectedLanguage)?.label ?? selectedLanguage.toUpperCase()}</Text>
                    </TouchableOpacity>
                    ...
                    <Pressable style={styles.languageModal} onPress={e => e.stopPropagation()}>
                        ...
                        {languages.map(language => (
                            <TouchableOpacity
                                ...
                                onPress={() => handleLanguageSelect(language.code as 'en' | 'ar')}
                            >
                                <Text
                                    style={[
