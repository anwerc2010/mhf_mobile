...
import { HouseIcon, CreditCardIcon, StethoscopeIcon, UserIcon, CaretLeftIcon } from 'phosphor-react-native';
...
function StackNavigator({ currentLanguage, onLanguageChange }: { currentLanguage: 'en' | 'ar'; onLanguageChange: (l: 'en' | 'ar') => void }) {
  return (
    <Stack.Navigator
      screenOptions={{
        header: () => <TopNavBar notificationCount={3} currentLanguage={currentLanguage} onLanguageChange={onLanguageChange} />,
      }}
    >
      <Stack.Screen
        name="Home"
...
function BottomTabNavigator({ currentLanguage, onLanguageChange }: { currentLanguage: 'en' | 'ar'; onLanguageChange: (l: 'en' | 'ar') => void }) {
  return (
    ...
    >
      ...
      <BottomTabStack.Screen
        ...
        options={({ navigation }) => ({
          ...
          headerShown: true,
          header: () => <BackButtonHeader navigation={navigation} title="Relief Program" />,
        })}
      />
      <BottomTabStack.Screen
        name="ApplyNewRelief"
        ...
        options={({ navigation }) => ({
          ...
          headerShown: true,
          header: () => <BackButtonHeader navigation={navigation} title="Request for Relief & Welfare" />,
        })}
      />
      <BottomTabStack.Screen
        name="Education"
        ...
        options={({ navigation }) => ({
          title: 'Education',
          headerShown: true,
          header: () => <BackButtonHeader navigation={navigation} title="Education" />,
        })}
      />
      <BottomTabStack.Screen
        ...
        options={({ navigation }) => ({
          ...
          headerShown: true,
          header: () => <BackButtonHeader navigation={navigation} title="Education & Skill Development" />,
        })}
      />
      <BottomTabStack.Screen
        name="Events"
        ...
        options={({ navigation }) => ({
          title: 'Events',
          headerShown: true,
          header: () => <BackButtonHeader navigation={navigation} title="Events" />,
        })}
      />
      <BottomTabStack.Screen
        ...
        options={({ navigation }) => ({
          ...
          headerShown: true,
          header: () => <BackButtonHeader navigation={navigation} title="Event Registration Form" />,
        })}
      />
      <BottomTabStack.Screen
        name="Volunteers"
        ...
        options={({ navigation }) => ({
          title: 'Volunteers',
          headerShown: true,
          header: () => <BackButtonHeader navigation={navigation} title="Volunteer Registration Form" />,
        })}
      />
      <BottomTabStack.Screen
        name="NewCardRequest"
        ...
        options={({ navigation }) => ({
          ...
          headerShown: true,
          header: () => <BackButtonHeader navigation={navigation} title="Request New Card" />,
...
function TopTabNavigator({ currentLanguage, onLanguageChange }: { currentLanguage: 'en' | 'ar'; onLanguageChange: (l: 'en' | 'ar') => void }) {
  return (
...
export default function AppNavigator() {
  const [language, setLanguage] = useState<'en' | 'ar'>(i18n.language && i18n.language.startsWith('ar') ? 'ar' : 'en');
  ...
  const renderNavigator = () => {
    switch (NAVIGATION_CONFIG.type) {
      case 'stack':
        return <StackNavigator currentLanguage={language} onLanguageChange={handleLanguageChange} />;
      case 'bottom-tabs':
        return <BottomTabNavigator currentLanguage={language} onLanguageChange={handleLanguageChange} />;
      case 'top-tabs':
        return <TopTabNavigator currentLanguage={language} onLanguageChange={handleLanguageChange} />;
      case 'drawer':
