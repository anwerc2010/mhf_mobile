...
import { useCreateCardRequestMutation, useGetDashboardDetailsQuery, useUploadDocumentMutation } from '@psi/shared-api';
...
function NewCardRequest() {
    ...
    const [createCardRequest, { isLoading, error }] = useCreateCardRequestMutation();
    ...
    const handleSubmit = async (data: Record<string, any>) => {
        try {
            ...
            Alert.alert(
                'Error',
                err?.data?.message || 'Failed to submit card request. Please try again.',
                [{ text: 'OK' }]
            );
        }
    }
